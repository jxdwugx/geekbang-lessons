...
public @interface EnableMyBatis {
    ...
    String transactionFactory() default "transactionFactory";

    String configurationProperties() default "configurationProperties";

    String sqlSessionFactory() default "sqlSessionFactory";

    String failFast() default "";
    ...
    String cache() default "cache";

    String objectFactory() default "objectFactory";

    String objectWrapperFactory() default "objectWrapperFactory";
