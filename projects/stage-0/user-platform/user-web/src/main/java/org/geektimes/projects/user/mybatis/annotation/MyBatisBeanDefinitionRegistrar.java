...
public class MyBatisBeanDefinitionRegistrar implements ImportBeanDefinitionRegistrar, EnvironmentAware {
    ...
    public void registerBeanDefinitions(AnnotationMetadata importingClassMetadata, BeanDefinitionRegistry registry) {
        ...
        beanDefinitionBuilder.addPropertyReference("transactionFactory", (String) attributes.get("transactionFactory"))
                .addPropertyReference("configurationProperties", (String) attributes.get("configurationProperties"))
                .addPropertyReference("sqlSessionFactory", (String) attributes.get("sqlSessionFactory"))
                .addPropertyValue("failFast", attributes.get("failFast"))
        //Interceptor[] plugins
        // TypeHandler<?>[]
                .addPropertyValue("defaultEnumTypeHandler", attributes.get("defaultEnumTypeHandler"))
                .addPropertyValue("typeAliasesSuperType", attributes.get("typeAliasesSuperType"))
                .addPropertyValue("typeAliasesPackage", attributes.get("typeAliasesPackage"))
                .addConstructorArgValue(attributes.get("cache"))
                .addConstructorArgValue(attributes.get("objectFactory"))
                .addConstructorArgValue(attributes.get("objectWrapperFactory"));
